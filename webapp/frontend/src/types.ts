export type PageKey = "panorama" | "pathologies" | "csp" | "mortality" | "analysis" | "benchmarks" | "extraction" | "methodology";
...
export type Panorama = {
  ...
  facts: Array<{ label: string; text?: string; value?: number; value_pct?: number | null; kind: string }>;
  kpis: Array<{
    key: string;
    type: "metric" | "driver";
    label: string;
  ...
  concentration: Array<{ label: string; value: number; share: number; cumulative_share: number }>;
  reliability: Reliability;
